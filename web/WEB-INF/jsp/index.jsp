    ...
    <body ng-controller="appCtrl">
        ...
        <div class="container">
            ...
            <div class="col-md-12" style="text-align: center; margin-top: 60px;">
                &copy; Sayeed tuhin
                || <a href="#" target="_blank">Youtube</a>  || <a href="#" target="_blank">Facebook</a>
            </div>
        ...
        <div class="floating_div" style="text-align: center;width: 120px; height: 190px; border: 1px solid #DDD; box-shadow: 0px 0px 5px #DDD; position: fixed; right: 0px; bottom: 0px;">
            <a href="" target="_blank"><img src="<c:url value="/resources/img/sayeed.jpg"></c:url>" width="100%"/></a>
            <br/>

           Sayeed Tuhin <br/>
            <a href="https://www.facebook.com/SayeedTuhin-2431130696958908/?modal=admin_todo_tour" target="_blank"><i class="fa fa-facebook"></i> Facebook</a> <br/>
